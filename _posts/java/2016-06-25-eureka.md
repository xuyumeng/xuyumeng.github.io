...
![architecture-overview](/img/post/java/eureka/architecture-overview.png)
...
![architecture-detail](/img/post/java/eureka/architecture-detail.png)
...
![eureka-server-init-page](/img/post/java/eureka/eureka-server-init-page.png)
...
![eureka-server-with-service-provider](/img/post/java/eureka/eureka-server-with-service-provider.png)
...
![eureka-server-register](/img/post/java/eureka/eureka-server-register.png)
...
![eureka-server-renew](/img/post/java/eureka/eureka-server-renew.png)

#### 3.3.3 Cancel

Cancel（服务下线）一般在Service Provider shut down的时候调用，用来把自身的服务从Eureka Server中删除，以防客户端调用不存在的服务。接口实现如下图所示。

![eureka-server-cancel](/img/post/java/eureka/eureka-server-cancel.png)
...
![eureka-server-fetch](/img/post/java/eureka/eureka-server-fetch.png)
...
![eureka-server-evict](/img/post/java/eureka/eureka-server-evict.png)
...
![eureka-server-peer-discovery](/img/post/java/eureka/eureka-server-peer-discovery.png)
...
![eureka-server-peer-init](/img/post/java/eureka/eureka-server-peer-init.png)
...
![service-provider-register](/img/post/java/eureka/service-provider-register.png)
...
![service-provider-renew](/img/post/java/eureka/service-provider-renew.png)
...
![service-provider-cancel](/img/post/java/eureka/service-provider-cancel.png)
...
![client-discover-eureka-server](/img/post/java/eureka/client-discover-eureka-server.png)
...
![service-consumer-fetch-registries](/img/post/java/eureka/service-consumer-fetch-registries.png)

#### 3.5.2 Update Service Registries

由于在本地有一份缓存，所以需要定期更新，定期更新频率可以通过`eureka.client.registryFetchIntervalSeconds`配置。

![service-consumer-update-registries](/img/post/java/eureka/service-consumer-update-registries.png)
